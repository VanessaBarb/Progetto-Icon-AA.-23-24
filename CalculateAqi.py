...
"""
Calcolo AQI per ciascun inquinante
...
def calculate_aqi(C, C_LO, C_HI, I_LO, I_HI):
    ...
    :param C: Concentrazione dell'inquinante misurata
    :param C_LO: Limite inferiore della concentrazione per la categoria
    :param C_HI: Limite superiore della concentrazione per la categoria
    :param I_LO: Limite inferiore dell'AQI per la categoria
    :param I_HI: Limite superiore dell'AQI per la categoria
    :return: Valore AQI
    """
...
def calculate_aqi(concentration, breakpoints):
    ...
    :param concentration: Concentrazione dell'inquinante
    :param breakpoints: Lista di tuple con i breakpoint (C_LO, C_HI, I_LO, I_HI)
    :return: Valore AQI
    """
...
# Assicurati che tutte le colonne AQI siano state create
...
df_filtered.to_csv('globalAirQualityUp.csv')
