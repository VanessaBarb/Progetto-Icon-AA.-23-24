...
def city_tuning(aqi_data,temperature_data):
    ...
    temperature_data.to_csv(r"C:\Users\Stefano\Desktop\ICON\city_temperature_fined1.csv", index=False)
...
def yearly_temperature_avg(temperature_dataset):
    ...
    output_file_path = r"C:\Users\Stefano\Desktop\ICON\city_temperature_yearly.csv"
...
def aqi_data_refinement(aqi_data):
    ...
    aqi_data.to_csv(r"C:\Users\Stefano\Desktop\ICON\air_index_refined.csv", index=False)
    print("done")
...
def date_restriction(temperature_dataset):
    ...
    temperature_dataset.to_csv(r"C:\Users\Stefano\Desktop\ICON\city_temperature_fined.csv", index=False)
...
def fuse_datasets(aqi_dataset,temperature_dataset):
    ...
    merged_df.to_csv(r"C:\Users\Stefano\Desktop\ICON\yearly_temperature_aqi.csv", index=False)
